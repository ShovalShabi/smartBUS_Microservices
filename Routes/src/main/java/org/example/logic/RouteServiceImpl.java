...
public class RouteServiceImpl implements RouteService {
    ...
    public Flux<RouteResponse> getRoute(RouteRequest routeRequest) {
        ...
        return groupTransitDetailsByList(googleApiService.getRouteFromApi(routeRequest))
                .flatMapMany(Flux::fromIterable) // Flatten the list of lists
                .flatMap(groupedTransitDetails -> getRouteResponses(groupedTransitDetails, routeRequest)); // Get the route responses from the grouped transit details
    }
     ...
     */
    private Mono<RouteResponse> getRouteResponses(List<TransitDetails> groupedTransitDetails, RouteRequest routeRequest) {
